...
const DashboardNewSong = () => {
    ...
    const [{ allArtists, allAlbums, artistFilter, allSongs, albumFilter, filterTerm, languageFilter }, dispath] = useStateValue();
    ...
    const saveSong = () => {
        if (!songImageCover || !audioImageCover) {
            //throw the alert
            alert("Required fileds are not filled!!!!!");
            ...
            saveNewSong(data).then((res) => {
                getAllSongs().then((songs) => {
                    dispath({ type: actionType.SET_All_SONGS, allSongs: songs.songs });
                });
            });
    ...
    return (
        <div className="flex flex-col items-center justify-center p-4 border border-gray-300 gap-4 rounded-md">
            ...
            <div className="flex items-center justify-cemter w-60 cursor-pointer p-4">
