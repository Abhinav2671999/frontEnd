    ...
    return (
        ...
        >
            ...
            <p className='text-base text-center  text-headingColor font-semibold my-2'>
                ...
                {data.artist && (
                    <span className=' block text-sm text-gray-400 my-1 text-center '>
            ...
            {isDelete && (
                <motion.div className=' absolute inset-0 backdrop-blur-md bg-cardOverlay flex items-center flex-col justify-center px-4 py-2 gap-0'
                    ...
                    animate={{ opacity: 1 }}
                >
                    <p className='text-lg text-textColor font-semibold text-center'>Are you sure do you want to delete it?</p>
